...
* **Manuscript & Documentation**: [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)

See the [LICENSE](LICENSE) and [NOTICE](NOTICE) files for the full legal text and attribution requirements.
