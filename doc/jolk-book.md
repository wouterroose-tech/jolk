...
**Substrate**: The physical execution layer (typically the JVM or GraalVM) where high-level symbolic identities are projected onto machine-level realities.  
